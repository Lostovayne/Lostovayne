...
| **Trello Platforms** <br> *Advanced project tracking system with customizable workflows and team collaboration tools* | `Next.js 15` `Prisma` `Auth` | [View Code](https://github.com/Lostovayne/SaaS-Replica-completa-de-trello) |
